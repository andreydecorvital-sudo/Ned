...
O registro histórico não substitui o Brand OS. Em caso de conflito, prevalece a decisão mais recente marcada como **APROVADO**, confirmada pela atualização vigente, pelo `STYLESEED.md` e pelo estado atual do código.
